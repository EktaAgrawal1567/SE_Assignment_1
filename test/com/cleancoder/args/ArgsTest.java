...
public class ArgsTest {
  ...
  @Test
  public void testIntegerAndString() throws Exception{
    Args args = new Args("x#,y*", new String[]{"-x", "42","-y","alpha"});
    assertTrue(args.has('x'));
    assertEquals(42, args.getInt('x'));
    assertTrue(args.has('y'));
    assertEquals("alpha", args.getString('y'));
  ...
  public void testTwoIntegers() throws Exception{
    Args args = new Args("x#,y#", new String[]{"-x", "42","-y","24"});
    assertTrue(args.has('x'));
    assertEquals(42, args.getInt('x'));
    assertTrue(args.has('y'));
    assertEquals(24, args.getInt('y'));
    assertEquals(4, args.nextArgument());
  }
  ...
  @Test
  public void testTwoDouble() throws Exception{
    Args args = new Args("x##,y##", new String[]{"-x", "42.1","-y","24.3"});
    assertTrue(args.has('x'));
    assertEquals(42.1, args.getDouble('x'), .001);
    assertTrue(args.has('y'));
    assertEquals(24.3, args.getDouble('y'), .001);
    assertEquals(4, args.nextArgument());
  }    

  @Test
  public void testDoubleAndString() throws Exception{
    Args args = new Args("x##,y*", new String[]{"-x", "42.1","-y","alpha"});
    assertTrue(args.has('x'));
    assertEquals(42.1, args.getDouble('x'), .001);
    assertTrue(args.has('y'));
    assertEquals("alpha", args.getString('y'));
  ...
  @Test
  public void testDoubleAndInteger() throws Exception{
    Args args = new Args("x##,y#", new String[]{"-x", "42.1","-y","12"});
    assertTrue(args.has('x'));
    assertEquals(42.1, args.getDouble('x'), .001);
    assertTrue(args.has('y'));
    assertEquals(12, args.getInt('y'));
    assertEquals(4, args.nextArgument());
  }   

  @Test
  public void testFewerArguments() throws Exception{
    Args args=new Args("x#,y*,z##",new String[]{"-x","12","-y","alpha"});
    assertTrue(args.has('x'));
    assertEquals(12, args.getInt('x'));
    assertTrue(args.has('y'));
    assertEquals("alpha", args.getString('y'));
    assertEquals(4, args.nextArgument());
  } 
